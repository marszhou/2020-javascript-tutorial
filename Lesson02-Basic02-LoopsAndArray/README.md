...
1. 用循环填充数组，数字从201到400的整数序列就是，填充后是[200,201,202,...400][☆答案☆](assignments/s1.html)

2. 补全下面的代码[☆答案☆](assignments/s2.html)
...
3.补全以下代码[☆答案☆](assignments/s3.html)
...
4.对第1题中的数组做求和处理，打印结果[☆答案☆](assignments/s4.html)

5.取出第1题中的数组结果中所有的奇数使它们组成一个新数组[☆答案☆](assignments/s5.html)

6.补全以下代码[☆答案☆](assignments/s6.html)
...
7.补全以下代码[☆答案☆](assignments/s7.html)
...
8.补全以下代码[☆答案☆](assignments/s8.html)
